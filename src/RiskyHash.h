...
uint64_t fio_risky_hash64(const void *data_, size_t len, uint64_t seed) {
  ...
  register uint64_t v0 = seed ^ FIO_RISKY_PRIME_1;
  register uint64_t v1 = ~seed + FIO_RISKY_PRIME_1;
  register uint64_t v2 = fio_lrot64(seed, 17) ^ (FIO_RISKY_PRIME_1 + FIO_RISKY_PRIME_0);
  register uint64_t v3 = fio_lrot64(seed, 33) + (~FIO_RISKY_PRIME_1);
  ...
  result += len;
  result += v0 * FIO_RISKY_PRIME_1;
  result ^= fio_lrot64(result, 13);
  result += v1 * FIO_RISKY_PRIME_1;
  result ^= fio_lrot64(result, 29);
  result += v2 * FIO_RISKY_PRIME_1;
  result ^= fio_lrot64(result, 33);
  result += v3 * FIO_RISKY_PRIME_1;
...
void fio_risky_hash128(const void *data_, size_t len, uint64_t *h1,  uint64_t *h2) {
  /* The consumption vectors initialized state */
  register uint64_t v0 = h1[0] ^ FIO_RISKY_PRIME_1;
  register uint64_t v1 = ~h2[0] + FIO_RISKY_PRIME_1;
  register uint64_t v2 = fio_lrot64(h1[0], 17) ^ (FIO_RISKY_PRIME_1 + FIO_RISKY_PRIME_0);
  register uint64_t v3 = fio_lrot64(h2[0], 33) + (~FIO_RISKY_PRIME_1);
  ...
  h1[0] += len;
  h1[0] += v0 * FIO_RISKY_PRIME_1;
  h1[0] ^= fio_lrot64(h1[0], 13);
  h1[0] += v1 * FIO_RISKY_PRIME_1;
  h1[0] ^= fio_lrot64(h1[0], 29);
  h1[0] += v2 * FIO_RISKY_PRIME_1;
  h1[0] ^= fio_lrot64(h1[0], 33);
  h1[0] += v3 * FIO_RISKY_PRIME_1;
